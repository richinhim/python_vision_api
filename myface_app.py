...
if __name__ == '__main__':
    #
    # parse = argparse.ArgumentParser(description='얼굴인식프로그램')
    # parse.add_argument('input_image', help='분석할 사진 입력')
    # parse.add_argument('---out', dest='output', default='out.jpg', help='분석 결과 저장명 입력')
    # parse.add_argument('--max-results', dest='Max_results', default=4, help='출력 결과수 ')
